...
function Presentation() {
  return (
    <div id="bg-container" className="bg-[url('/fundobase.jfif')] bg-cover bg-center h-max-[800px] h-[500px] lg:h-[800px] flex flex-col text-left p-8 mb-[32px] lg:mb-[64px] relative">
