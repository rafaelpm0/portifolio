...
const drawerContentVariants = cva('fixed z-50 flex h-100% flex-col border bg-[#c1c1c2] overflow-auto', {
  variants: {
    direction: {
...
>(({ className, children, ...props }, ref) => {
  const { direction, wfull } = React.useContext(DrawerContext);
  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn(drawerContentVariants({ direction, wfull, className }))}
        {...props}
      >
